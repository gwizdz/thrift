...
#ifndef _THRIFT_SERVER_TTCPSERVER_H_
#define _THRIFT_SERVER_TTCPSERVER_H_
...
enum IOConcurrencyStrategy
{
  IOServiceInThreadPool,
  IOServicePerCore
};
...
#endif // _THRIFT_SERVER_TTCPSERVER_H_
