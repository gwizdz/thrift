...
#ifndef _THRIFT_SERVER_TCP_TLS_SERVER_HPP_
#define _THRIFT_SERVER_TCP_TLS_SERVER_HPP_

#include <thrift/server/tcp/basic_server.hpp>
#include <thrift/server/tcp/tls/connection.hpp>
...
#endif // _THRIFT_SERVER_TCP_TLS_SERVER_HPP_
